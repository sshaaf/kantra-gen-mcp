...
public class JavaRuleTools {
    ...
    @Tool(description = "Use for most Java code references. Builds a condition to find a Java element (like a class, method, or annotation usage) based on its location and pattern.")
    ...
    @Tool(description = "Use this ONLY when you need to find a Java element that is ALSO annotated with another specific annotation. For example, to find a FIELD of a certain type that has the '@Inject' annotation.")
    ...
    @Tool(description = "Creates an annotation specification for use with buildJavaReferencedWithAnnotation.")
    ...
    @Tool(description = "Creates an annotation element for use with createAnnotation.")
